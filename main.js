...
const appendProjectToDom = (projectName) => {
  ...
  deleteIconImg.setAttribute("src", _icons_delete_svg__WEBPACK_IMPORTED_MODULE_1__);
...
const createTaskCard = (taskObj) => {
  ...
  if (check) {
    ...
    tickIconImg.setAttribute("src", _icons_tick_svg__WEBPACK_IMPORTED_MODULE_0__);
...
const appendTaskToDOM = (taskObj) => {
  ...
  taskCard.addEventListener("click", (e) => {
    ...
    if (unChecked) {
      ...
      const tickIconImg = document.createElement("img");
      tickIconImg.setAttribute("class", "tick-img");
      tickIconImg.setAttribute("src", _icons_tick_svg__WEBPACK_IMPORTED_MODULE_2__);
      tickIconImg.setAttribute("alt", "tick icon");
...
module.exports = __webpack_require__.p + "1a5cb163c436f6b83647.svg";
